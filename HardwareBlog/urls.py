"""
URL configuration for HardwareBlog project.
...
from AppBlog.views import index, ProductList, ProductDetail, ProductCreate, ProductUpdate, ProductDelete, SignUp, Login, Logout, ProfileUpdate, ProfileCreate, ProfileDetail, MensajeCreate, MensajeDelete, MensajeList, about
