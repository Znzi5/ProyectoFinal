...
from AppBlog.models import Product, Profile, Mensaje
from django.urls import reverse_lazy
from AppBlog.forms import BuscarProductoForm
...
class ProductUpdate(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def handle_no_permission(self):
        return render(self.request, "HardwareBlog/not_found.html")
...
class ProductDelete(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    ...
    def handle_no_permission(self):
        return render(self.request, "AppBlog/not_found.html")
